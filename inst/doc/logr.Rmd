---
title: "Create Logs for R Scripts"
author: "David Bosak"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Create Logs for R Scripts}
...
![logr version](https://www.r-pkg.org/badges/version/logr)
![logr lifecycle](https://img.shields.io/badge/lifecycle-stable-blue.svg)
![logr downloads](https://cranlogs.r-pkg.org/badges/grand-total/logr)
![Travis build status](https://travis-ci.com/dbosak01/logr.svg?branch=master)
